                      ...
                      <div className="overflow-scroll bg-gradient-to-tr from-azure-radiance-300 to-azure-radiance-100 h-64">
                        ...
                        <div className={`grid h-64 ${notifications.shown == 'settings' || 'hidden'}`}>
                          ...
                          <label className="relative inline-flex items-center cursor-pointer">
                            ...
                            checked={notifications.settings.browser && true}/>
                            <div className="w-11 h-6 bg-gray-200 rounded-full dark:bg-gray-700 peer peer-checked:after:translate-x-full
                             peer-checked:after:border-white after:absolute after:top-[2px] after:left-[2px] after:bg-white
                             after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all
                             dark:border-gray-600 peer-checked:bg-azure-radiance-500"></div>
                            <span className="ml-3 text-sm text-gray-900 font-bold">Browser Notifications</span>
                          </label>
                          <label className="relative inline-flex items-center cursor-pointer mt-2">
                            <input onChange={() => dispatch(updateSettings('email'))} value={notifications.settings.email} 
                            type="checkbox" className="sr-only peer" checked={notifications.settings.email && true}/>
                            <div className="w-11 h-6 bg-gray-200 rounded-full dark:bg-gray-700 peer peer-checked:after:translate-x-full
                             peer-checked:after:border-white after:absolute after:top-[2px] after:left-[2px] after:bg-white
                             after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all
                             dark:border-gray-600 peer-checked:bg-azure-radiance-500"></div>
                          ...
                          <label className="relative inline-flex items-center cursor-pointer mt-2">
                            <input onChange={() => dispatch(updateSettings('telegram'))} value={notifications.settings.telegram}
                             type="checkbox" className="sr-only peer" checked={notifications.settings.telegram && true}/>
                            <div className="w-11 h-6 bg-gray-200 rounded-full dark:bg-gray-700 peer peer-checked:after:translate-x-full
                             peer-checked:after:border-white after:absolute after:top-[2px] after:left-[2px] after:bg-white
                             after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all
                             dark:border-gray-600 peer-checked:bg-azure-radiance-500"></div>
                        ...
                        <div className={notifications.shown == 'notifications' || 'hidden'}>
                          ...
                          {notifications.items.length > 0 && notifications.items.map((notification, index) => {
                            return (
                              <div key={index} className={`${notification.read || 'hover:bg-azure-radiance-500 bg-azure-radiance-400'} 
                              flex flex-col justify-between h-12 hover:bg-azure-radiance-400 bg-azure-radiance-300 m-1 rounded-md`}>
