            ...
            <div className="relative bg-gradient-to-tr from-azure-radiance-400 to-azure-radiance-300 p-7">
              <form>
                  ...
                  <div className=''>
                    <Listbox onChange={(value) => dispatch(updatePriority(value))} value={priority}>
                      <div className="fixed mt-1">
                        ...
                        text-left focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white
                ...
                <div className="flex flex-col">
                  <a onClick={newTaskHandler} className={`special-tab ${title.length > 0? 'cursor-pointer' : 'cursor-not-allowed'}`}>
